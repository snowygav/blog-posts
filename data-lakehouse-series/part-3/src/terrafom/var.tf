...
variable "redshift_cluster_name" {
  ...
  default = "lakehouse-spectrum-poc"
}
...
variable "trusted_db" {
  description = "Redshift database name."
  default     = "trusted_redshift"
}

variable "category_schema_json" {
  type        = string
  description = "A JSON file with the schema definition."
  default = "glue/category_schema.json"
}

variable "tbldate_schema_json" {
  type        = string
  description = "A JSON file with the schema definition."
  default = "glue/tbldate_schema.json"
}

variable "event_schema_json" {
  type        = string
  description = "A JSON file with the schema definition."
  default = "glue/event_schema.json"
}

variable "listing_schema_json" {
  type        = string
  description = "A JSON file with the schema definition."
  default = "glue/listing_schema.json"
}

variable "sales_schema_json" {
  type        = string
  description = "A JSON file with the schema definition."
  default = "glue/sales_schema.json"
}

variable "user_schema_json" {
  type        = string
  description = "A JSON file with the schema definition."
  default = "glue/user_schema.json"
}

variable "venue_schema_json" {
  type        = string
  description = "A JSON file with the schema definition."
  default = "glue/venue_schema.json"
}
...
variable "emr_configurations_json" {
  ...
  default = "emr/configuration.json"
}  
